...
{
    public abstract class ColorAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ColorAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ColorAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ColorAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ColorAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ColorAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ColorAppDbContext, Task<T>> func)
        {
            T result;
